...
- [ ] Shared draft context across slots
- [ ] Repro CUDA illegal memory access
- [ ] Hardware alternative analysis ($ used 3090 / cloud) — only if VRAM/accept kill criteria fires
