...
static constexpr __host__ __device__ tile_x_sizes mmq_get_dp4a_tile_x_sizes(ggml_type type, int mmq_y) {
    switch (type) {
        ...
        case GGML_TYPE_Q1_0_G128: return MMQ_DP4A_TXS_Q8_0;
...
template <int mmq_y, int nwarps, bool need_check> static __device__ __forceinline__ void load_tiles_q1_0_g128(
    ...
    GGML_UNUSED(x); GGML_UNUSED(x_tile); GGML_UNUSED(kbx0); GGML_UNUSED(i_max); GGML_UNUSED(stride);
    NO_DEVICE_CODE;
#else
    int   * x_qs = (int   *)  x_tile;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nrows*nwarps) {
        ...
        const block_q1_0_g128 * bxi = (const block_q1_0_g128 *)(x + i*stride) + kbx0 + kbx;
...
#pragma unroll
    for (int i0 = 0; i0 < mmq_y; i0 += nwarps) {
        ...
        const block_q1_0_g128 * bxi = (const block_q1_0_g128 *)(x + i*stride) + kbx0 + scale_block;
