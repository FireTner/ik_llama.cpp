...
static const std::map<llm_arch, std::map<llm_tensor, std::string>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_DSPARK,
        {
            ...
            { LLM_TENSOR_FFN_DOWN,                "blk.%d.ffn_down" },
            { LLM_TENSOR_FFN_UP,                  "blk.%d.ffn_up" },
            // Prism GGUFs use dotted names under "dspark.*" (not underscore "dspark_*").
    ...
    },
    {
        LLM_ARCH_NUH,
        {
            { LLM_TENSOR_TOKEN_EMBD,             "embed" },
            { LLM_TENSOR_OUTPUT_NORM,            "norm" },
            { LLM_TENSOR_OUTPUT,                 "lm_head" },
            { LLM_TENSOR_NUH_KDA_NORM,           "blocks.%d.mixer.norm_weight" },
            { LLM_TENSOR_ATTN_NORM,              "blocks.%d.mixer.norm" },
            { LLM_TENSOR_SSM_CONV1D,             "blocks.%d.mixer.conv.conv" },
            { LLM_TENSOR_SSM_IN,                 "blocks.%d.mixer.in_proj" },
            ...
            { LLM_TENSOR_SSM_OUT,                "blocks.%d.mixer.out_proj" },
            { LLM_TENSOR_ATTN_Q,                 "blocks.%d.mixer.q_proj" },
            ...
            { LLM_TENSOR_ATTN_OUT,               "blocks.%d.mixer.out_proj" },
            { LLM_TENSOR_FFN_NORM,               "blocks.%d.mlp_norm" },
            { LLM_TENSOR_FFN_GATE_UP,            "blocks.%d.mlp.w12" },
            { LLM_TENSOR_FFN_DOWN,               "blocks.%d.mlp.w3" },
        },
    },
    {
        LLM_ARCH_UNKNOWN,
