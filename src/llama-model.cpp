...
static const std::map<llm_arch, std::map<llm_tensor, std::string>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_DSPARK,
        {
            ...
            { LLM_TENSOR_FFN_DOWN,                "blk.%d.ffn_down" },
            { LLM_TENSOR_FFN_UP,                  "blk.%d.ffn_up" },
            { LLM_TENSOR_DSPARK_FC,               "dspark_fc" },
            { LLM_TENSOR_DSPARK_HIDDEN_NORM,      "dspark_hidden_norm" },
            { LLM_TENSOR_DSPARK_MARKOV_HEAD_A,    "dspark_markov_head_a" },
            { LLM_TENSOR_DSPARK_MARKOV_HEAD_B,    "dspark_markov_head_b" },
            { LLM_TENSOR_DSPARK_CONFIDENCE_HEAD,  "dspark_confidence_head" },
            { LLM_TENSOR_DSPARK_LOG_SNR_FC1,      "dspark_log_snr_fc1" },
            { LLM_TENSOR_DSPARK_LOG_SNR_FC2,      "dspark_log_snr_fc2" },
        },
    },
    {
